...
显然，如果得到了通解，又能将其所有的任意常数确定下来，通解就会变成特解．一个典型的例子是初值问题：
...
例如，微分方程 :math:`y_x = y` 及其在 :math:`x=0` 处的初值条件 :math:`y(0)=1` 就组成了一个初值问题，其解为 :math:`y=\ue^t`．
...
.. [#indep] 此处的“独立”是指它们的 Jacobi 行列式z非零：
